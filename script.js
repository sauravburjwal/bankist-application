...
btnTransfer.addEventListener('click', function (e) {
  e.preventDefault();
  const sendAccount = accounts.find(
  ...
  if (
    sendAccount &&
    sendAccount?.username !== currentAccount.username &&
    sendAmount >= 0 &&
    sendAmount <= currentAccount.balance
  ) {
    currentAccount.movements.push(-sendAmount);
    sendAccount?.movements.push(sendAmount);
    currentAccount.movementsDates.push(new Date().toISOString());
    sendAccount.movementsDates.push(new Date().toISOString());
